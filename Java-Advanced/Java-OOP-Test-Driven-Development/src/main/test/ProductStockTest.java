...
public class ProductStockTest {
    ...
    public void findShouldThrowExceptionIfInvalidIndex() {
    ...
    @Test
    public void changeQuantityAddingShouldWorkCorrect() {
        Product product = this.createProducts(1).get(0);
        this.productStock.add(product);
    ...
    public void changeQuantityShouldThrowExceptionIfNotPresent() {
        Product product = this.createProducts(1).get(0);
        this.productStock.changeQuantity(product.getLabel(), 0);
        Assert.assertEquals(0, product.getQuantity());
    }
    ...
    @Test(expected = IllegalArgumentException.class)
    public void findByLabelShouldThrowExceptionIfNotExisting() {
        Product product = this.createProducts(1).get(0);
        this.productStock.findByLabel(product.getLabel());
    }

    @Test
    public void findFirstNByAlphabeticalOrderShouldReturnCorrectOrder() {
    ...
    @Test
    public void findFirstNByAlphabeticalOrderShouldReturnEmptyCollectionOnEmptyStock() {
    ...
    @Test
    public void findFirstNByAlphabeticalOrderShouldReturnEmptyCollectionWithIllegalArgument() {
        List<Product> products = this.createProducts(3);
        products.get(0).setLabel("A");
        products.get(1).setLabel("B");
        products.get(2).setLabel("C");
