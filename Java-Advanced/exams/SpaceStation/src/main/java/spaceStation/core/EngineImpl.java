...
public class EngineImpl implements Engine {
    ...
    private String retireAstronaut(String[] data) {
        String res = this.controller.retireAstronaut(data[0]);
        return res;
    }
    ...
    private String explorePlanet(String[] data) {
        String res = this.controller.explorePlanet(data[0]);
        return res;
    }
    ...
    private String addPlanet(String[] data) {
        ...
        String res = this.controller.addPlanet(name, items);
        return res;
    }

    private String addAstronaut(String[] data) {
        String res = this.controller.addAstronaut(data[0], data[1]);
        return res;
    }
}
