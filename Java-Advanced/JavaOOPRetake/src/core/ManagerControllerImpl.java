...
public class ManagerControllerImpl implements ManagerController {
    ...
    public String addPlayerCard(String username, String cardName) {
        ...
        String message = String.format(SUCCESSFULLY_ADDED_PLAYER_WITH_CARDS, cardName, username);
        return message;
    }
    ...
    public String fight(String attackUser, String enemyUser) {
        ...
        String message = String.format(FIGHT_INFO, attackPlayer.getHealth(), enemyPlayer.getHealth());
        return message;
    }
